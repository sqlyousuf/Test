...
SELECT  @SPInfo = 
		...
		CASE @ProductName
			    WHEN 'SQL Server 2016' THEN 
											CASE @ProductVersion
												WHEN '13.0.4001.0' THEN 'You have already installed the latest cumulative update.' 
												ELSE 'Install the latest Cumulative Update (CU) of RTM:  CU3, <https://support.microsoft.com/en-us/kb/3205413>'
											END
				WHEN 'SQL Server 2014' THEN 
											CASE @ProductVersion
												WHEN '12.0.5522.0' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of SP2:  CU2, <https://support.microsoft.com/en-us/kb/3188778>'
											END
				WHEN 'SQL Server 2012' THEN
											CASE @ProductVersion
												WHEN '11.0.6567.0 ' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of SP3:  CU6, <https://support.microsoft.com/en-us/kb/3194992>'
											END
...
BEGIN
	...
	END
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '11.0.5657.0')
	BEGIN
		SET @CumulativeUpdate = 'CU14'; SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/3180914';
	END
	ELSE IF (@ProductLevel = 'SP3') AND (@ProductVersion < '11.0.6567.0')
	BEGIN
		SET @CumulativeUpdate = 'CU6'; SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/3194992';
	END
	SELECT  @OtherProduct = 
			CASE 
				WHEN @ProductLevel = 'RTM' THEN ' If you want to upgrade to higher edition, please intall service pack.'
...
BEGIN
	...
	END
	ELSE IF (@ProductLevel = 'SP1') AND (@ProductVersion < '12.0.4474.0')
	BEGIN
		SET @CumulativeUpdate = 'CU9'; SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/3186964';
	END
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '12.0.5522.0')
	BEGIN
		SET @CumulativeUpdate = 'CU2'; SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2936603';
	END
